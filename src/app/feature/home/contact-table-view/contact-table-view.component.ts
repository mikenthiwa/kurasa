...
@Component({
  selector: 'app-contact-table-view',
  imports: [MatTableModule, MatCheckboxModule, MatIconModule, MatButtonModule, MatSortModule],
  templateUrl: './contact-table-view.component.html',
  styleUrl: './contact-table-view.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ContactTableViewComponent implements OnChanges, AfterViewInit {
